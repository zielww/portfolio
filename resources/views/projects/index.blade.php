        ...
        <div class="max-w-7xl mx-auto text-center">
            ...
            @auth()
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="/projects/create" class="px-8 py-3 bg-gradient-to-r from-accent to-purple-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-accent/25 transition-all duration-300 transform hover:scale-105">
                        Add New Project
                    </a>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                @foreach($projects as $project)
                    <div onclick="window.location.href = '{{ url('/projects', $project->id) }}'" class="project-card card-hover rounded-xl overflow-hidden">
